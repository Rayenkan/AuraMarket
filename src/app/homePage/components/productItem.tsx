...
export default function ProductItem({
  ...
  return (
    <div className="relative flex flex-col rounded-xl justify-start w-[285px] h-[446px]  transition duration-200 cursor-pointer"  onClick={()=>pushRoute(`/products/${id}`)}>
      <Image
      ...
      <div className="p-4 space-y-2 text-black">
        <p className="font-semibold text-2xl line-clamp-1">{productName}</p>
        <p className="text-gray-400 font-medium line-clamp-1">{productDesc}</p>
