...
import AccountIcon from "@/app/homePage/_svgs/accountIcon";
import CartIcon from "@/app/homePage/_svgs/CartIcon";
...
const TopBar = () => {
  ...
  return (
    <div className="flex items-center justify-between w-full h-[100px] px-12 bg-white ">
      <div
        className="flex flex-row items-center text-black gap-2 [&>*]:cursor-pointer"
        onClick={() => pushRoute("/homePage")}
      >
      ...
      <div className="flex flex-row items-center gap-16 [&>*]:cursor-pointer">
        ...
        <p
          className="text-black font-medium text-base"
          onClick={() => pushRoute("/products")}
        >
          Products
        </p>
        <p
          className="text-black font-medium text-base"
          onClick={() => pushRoute("/AboutUs")}
        >
          About
        </p>
        <p
          className="text-black font-medium text-base"
          onClick={() => pushRoute("/Contact")}
        >
          Contact
        </p>
      </div>
